...
x/22}{X/22}{20-212}{Retzlaff, Das, Wallace, Mousavi, Saranti, Angerschmid, Afshari, Yang, Taylor, Holzinger}

% Short headings should be running head and authors last names

\ShortHeadings{Human-in-the-Loop Reinforcement Learning}{Retzlaff, Das, Wallace, Mousavi, Saranti, Angerschmid, Afshari, Yang, Taylor, Holzinger}
\firstpageno{1}
...
\subsection{Explainability}
%This is about explaning agent's behavior to humans; however this is still interactive
...
\item Srijita --- Investigation, Writing, Review, Editing
\item Christabel --- Research, Writing, Review, Editing.  
\item Payam
\item Anna
\item Alessa
\item Mohammad
\item Tianpei  --- Investigation, Writing - Original Draft preparation, Writing - Review & Editing
